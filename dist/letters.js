...
function (_Letter) {
  ...
  function Kletter(x, y) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Kletter).call(this, x, y));
    _this.dash = dash;
    return _this;
  }
...
function (_Letter2) {
  ...
  function Nletter(x, y) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Nletter).call(this, x, y));
    _this2.dash = dash;
    return _this2;
  }
